## https://hakril.github.io/PythonForWindows/build/html/_modules/windows/wintrust.html


import ctypes
import windows
from windows.crypto import CryptObject
...
def verify_microsft(filename):
    ...
    try:
        ...
        print(f"Error happened on check_cert - {error}")
        pass
